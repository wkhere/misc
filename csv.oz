...
in
   %todo: add states
   case I
   of nil then {RetAcc L}
   [] &"|&"|E then Z in {RetAcc L}|dquote|{Parse E S Z Z L}  
   [] &"|E then Z in {RetAcc L}|quote|{Parse E S Z Z quoted}
   [] C|E then U1 in U=C|U1 {Parse E S Acc U1 L}
   end
end
